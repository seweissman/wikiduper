...
echo "etc/hadoop-cluster.sh wikiduper.clir.minhashwiki.eval.WikiDoc2Sentence -elang ${elang} -ewiki ${epack} -flang ${flang} -fwiki ${fpack} -eout ${esent} -fout ${fsent}"
etc/hadoop-cluster.sh wikiduper.clir.minhashwiki.eval.WikiDoc2Sentence -elang ${elang} -ewiki ${epack} -flang ${flang} -fwiki ${fpack} -eout ${esent} -fout ${fsent}
