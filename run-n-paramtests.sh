# ./run-pipeline.sh [input] [output] [nhash] [nbits] [k] [N] [L]
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 8 8 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 8 10 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 8 12 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 8 14 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 8 16 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 9 8 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 9 10 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 9 12 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 9 14 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 9 16 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 10 8 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 10 10 12
./run-pipeline.sh enwiki-20130503-pack enwiki-20130503-sentences 20 30 10 12 12
