...
/**
 * Tool that builds the mapping from docids (String identifiers) to docnos
 * 
 * 
 */
public class TextDocnoMappingBuilder extends Configured implements Tool, DocnoMapping.Builder {
  private static final Logger LOG = Logger.getLogger(TextDocnoMappingBuilder.class);
  ...
  public TextDocnoMappingBuilder() {}
  ...
  public int run(String[] args) throws IOException {
    ...
    // Temp directory.
    String tmpDir = "tmp-" + TextDocnoMappingBuilder.class.getSimpleName() +
  ...
  public static void main(String[] args) throws Exception {
    LOG.info("Running " + TextDocnoMappingBuilder.class.getCanonicalName() +
        " with args " + Arrays.toString(args));
    ToolRunner.run(new Configuration(), new TextDocnoMappingBuilder(), args);
  }
}
